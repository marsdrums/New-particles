...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 296.0, 110.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 155.0, 81.0, 22.0 ],
					"text" : "roughness $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 471.0, 439.0, 261.0, 22.0 ],
					"text" : "jit.particle.force @type directional @amount 0.3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 471.0, 329.0, 445.0, 22.0 ],
					"text" : "jit.particle.force @type point_attractor @amount 0.2 @position 0 -8 0 @radius 200"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 435.0, 142.0, 47.0, 22.0 ],
									"text" : "* 2.331"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 440.0, 226.0, 33.0, 22.0 ],
									"text" : "* 2.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 440.0, 168.0, 24.0, 22.0 ],
									"text" : "sin"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 356.0, 47.0, 43.0, 22.0 ],
									"text" : "jit.time"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 269.75, 142.0, 29.5, 22.0 ],
									"text" : "* 3."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 275.0, 168.0, 24.0, 22.0 ],
									"text" : "sin"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 204.0, 142.0, 29.5, 22.0 ],
									"text" : "* 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 50.666680157184601, 221.333339333534241, 29.5, 22.0 ],
									"text" : "* 5."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 50.0, 190.000005066394806, 24.0, 22.0 ],
									"text" : "sin"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 217.0, 226.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 163.0, 226.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 107.0, 226.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 123.0, 282.0, 113.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 123.0, 364.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 663.0, 219.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 363.0, 30.0, 68.0, 22.0 ],
					"text" : "anim_reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 471.0, 277.0, 385.0, 22.0 ],
					"text" : "jit.particle.emitter @position 0. 0. 0. @rate 3421 @speed 0.1 @mass 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 207.0, 30.0, 145.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 207.0, 65.0, 241.0, 22.0 ],
					"text" : "jit.gl.camera part-ctx @tripod 1 @locklook 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 262.0, 35.0, 22.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 205.0, 503.0, 22.0 ],
					"text" : "jit.particle.obstacle @shape sphere @mode bounce @position 0 -9 0 @radius 5 @softness 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 65.0, 114.0, 62.0 ],
					"text" : "jit.world part-ctx @displaylink 0 @sync 0 @fps 400 @floating 1"
				}
